    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <h3>Texto de Números</h3>    
                
                <div class="form-group">
                    <label for="num1">Número :</label>
                    <input type="text" class="form-control" id="cantidad" name="cantidad" placeholder="Número">
                </div>
                <button id="sumar" class="btn btn-success">Generar Texto de Número</button>
                <br>
                <div class="form-group">
                    <label for="num1">Texto de Número :</label>
                    <input type="text" class="form-control" id="primos" name="primos" placeholder="Texto de Número" value="Treinta y tres mil trescientos treinta y tres">
                </div>
